...
# Load packages
library('magrittr');library('DT');library('plotly');library('heatmaply')
# Load data
load('vastused.Rda')
```
...
Järjestus põhineb mõjurite varieeruvuse sarnasusel: sarnaselt varieeruvad mõjud on teieneteise lähedal.
